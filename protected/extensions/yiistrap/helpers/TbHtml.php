...
class TbHtml extends CHtml // required in order to access the protected methods in CHtml
{
    ...
    const ICON_MOVE = 'icon-moveExtensively';
...
EOD;
     ...
     * @param array $names the option names to moveExtensively.
     * @param array $fromOptions the options to moveExtensively from.
     * @param array $options the options to moveExtensively to.
     * @return array the options.
     */
